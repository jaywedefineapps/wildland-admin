                    ...
                    <form action="{{ route('users.post') }}" method="post" id="kt_modal_add_business_form">
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <input type="hidden" name="type" name="type" value="user">
                                ...
                                <center style="padding-top: 25px">
                                    <div class="image-input image-input-circle image-input-empty" data-kt-image-input="true"
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px" id="show_image_div" loading="lazy"
                                            ...
                                            style="background-position:center; object-fit: contain;background-image: url('{{ isset($list->image) && $list->image != '' ? getS3Img($list->image) : asset('assets/media/avatars/blank.png') }}')">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="fv-row mb-7 col-md-6">
                                        ...
                                        <input class="form-control form-control-lg form-control-solid" type="text" id="password_confirmation"
                                            placeholder="Password Confirmation" name="password_confirmation" autocomplete="off"
                                            value="{{ old('password_confirmation', isset($list) ? $list->password_confirmation : '') }}" />
