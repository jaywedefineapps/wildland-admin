            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{route('admin.country')}}" type="button" class="btn btn-dark me-4" >Reset</a>
                        <button type="button" class="btn btn-primary" data-role='addCountry' data-bs-toggle="tooltip" data-bs-dismiss="click" title="Add country" data-bs-custom-class="tooltip-dark">Add</button>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                                ...
                                <td class="text-end">
                                    <div class="d-flex gap-3">
                                        <a href="#" data-id="{{ $item->id }}"
                                            data-name="{{ $item->name }}" data-default="{{ $item->default }}" data-code="{{ $item->code }}" data-category="{{ $item->category_id }}"
                                            data-role="editCountry" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Edit country " data-bs-custom-class="tooltip-dark">
                                        ...
                                        @if($item->default == 0)
                                        <a href="#" id="deleteCatId" data-role="deleteCountry"
                                            data-id="{{ $item->id }}" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Delete Country" data-bs-custom-class="tooltip-dark">
...
<div class="modal fade" id="kt_modal_add_country" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" id="kt_modal_add_country_form" enctype="multipart/form-data">
                @csrf
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_add_country_header">
                    <!--begin::Modal title-->
                    <h2 id="model_heading" class="fw-bolder">Add a Country</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div id="kt_modal_add_country_close"
                ...
                <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7 mt-1">
                                ...
                                <input type="text" class="form-control" placeholder="Country Name"
                                    name="name" id="country_name" value="" />
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7 mt-1">
                    ...
                    <div class="modal-footer flex-center">
                        <button type="reset" id="kt_modal_add_country_cancel"
                            class="btn btn-light me-3">Discard</button>
                        <button type="submit" id="kt_modal_add_country_submit"
...
<script>
    ...
    // <!--Start::Country Add Function-->
        $(document).on('click', 'button[data-role=addCountry]', function() {
            validator.resetForm();
            $('#kt_modal_add_country_form')[0].reset();
            $('#model_heading').html('Add Country');
            $('#kt_modal_add_country').modal('toggle');
        });
    // <!--End::Country Add Function-->

    // <!--Start::Country Edit Function-->
        $(document).on('click', 'a[data-role=editCountry]', function() {
            validator.resetForm();
            var id = $(this).data('id');
            var name = $(this).data('name');
            var code = $(this).data('code');
            var idDefault = $(this).data('default');
            $("#country_id").val(id);
            ...
            $('#model_heading').html('Edit a Country');
            $('#kt_modal_add_country').modal('toggle');
        });
    ...
    // <!--Start::Form Validation-->
        ...
        var validator = $('form[id="kt_modal_add_country_form"]').validate({
            rules: {
                name: {
                    noSpace: true
                },
            ...
            messages: {
                ...
                avatar: 'Category is required',
            },
            submitHandler: function(form) {
                var formData = new FormData($('#kt_modal_add_country_form')[0]);
                $.ajax({
    ...
    // <!--Start::Country Delete Function-->
        $(document).on('click', 'a[data-role=deleteCountry]', function() {
            var id = $(this).data('id');
            Swal.fire({
    ...
    // <!--Start::Country Model Close Function-->
        $('#kt_modal_add_country_close').click(function() {
            $('#kt_modal_add_country').modal('toggle');
        })
