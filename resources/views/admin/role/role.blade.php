                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <!--begin::Add customer-->
                            <button type="button" class="btn btn-primary" data-role='addSubCategory'
                                data-bs-toggle="tooltip" data-bs-dismiss="click" title="Add Role"
                                data-bs-custom-class="tooltip-dark">Add Role</button>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="kt_datatable">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Access count</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @if (count($list) > 0)
                                    @foreach ($rolesWithCount as $index => $item)
                                        <tr data-target="fullRow" id="{{ $item->id }}">
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td>{{ $item->role_access_count }}</td>
                                            {{-- <td>{{ $countdata[$item->id]}}</td> --}}
                                            <!--begin::Name=-->
                                            {{-- <td>{{ $item->type }}</td> --}}
                                            <!--end::Name=-->
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex gap-3">
                                                    <a href="#" data-id="{{ $item->id }}"
                                                        ...
                                                        data-role="editSubCategory" data-bs-toggle="tooltip"
                                                        data-bs-dismiss="click" title="Edit Role"
                                                    ...
                                                    <a href="#" id="deleteCatId" data-role="deleteRoleAccess"
                                                        data-id="{{ $item->id }}" data-bs-toggle="tooltip"
                                                        data-bs-dismiss="click" title="Delete Role"
                                                        data-bs-custom-class="tooltip-dark">
            ...
            <div class="modal-content">
                ...
                <form class="form" id="kt_modal_add_city_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-header" id="kt_modal_add_city_header">
                        ...
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div id="kt_modal_add_city_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_city_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="fv-row mb-7 mt-1">
                                    <label class="required fs-6 fw-bold mb-2">Access</label>
                                    <select class="form-select form-select-sm " id="accessId" name="access_id[]"
                        ...
                        <div class="modal-footer flex-center">
                            ...
                            <button type="submit" id="kt_modal_add_city_submit" class="btn btn-primary">
...
@section('script')
    <script>
        $(document).ready(function() {
           $("#accessId").select2({selectOnClose: true}).on("select2:selecting", function(evt) {
                $('#accessId-error').text('')
            });
            // <!--start::Datatable-->
            ...
            $(document).on('click', 'button[data-role=addSubCategory]', function() {
                validator.resetForm();
                var selectElement = $('select[name="access_id[]"]');
                selectElement.select2();
                $('#kt_modal_add_city_form')[0].reset();
                $('#model_heading').html('Add Role');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        selectElement.find('option').each(function() {
                            ...
                            if (data.some(item => item.access_id === optionValue)) {
                    ...
                    error: function(response) {
                        ...
                        $.each(response.responseJSON.msg, function(field_name,
                            error) {
            ...
            $(document).on('click', 'a[data-role=deleteRoleAccess]', function() {
                var id = $(this).data('id');
                // alert(id);
                Swal.fire({
                    text: "Are you sure you want to delete RoleAccess?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    ...
                    e.value ?
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data == 1) {
                                    Swal.fire({
                                        text: "You have deleted RoleAccess!.",
                                        icon: "success",
                                        buttonsStyling: !1,
                                        confirmButtonText: "Ok, Got it!",
                                        customClass: {
            ...
            $('#kt_modal_add_city_cancel').click(function() {
                // $('#kt_modal_add_city').modal('toggle');
                $("#Name").val();
                var selectElement = $('select[name="access_id[]"]');
                selectElement.select2();
