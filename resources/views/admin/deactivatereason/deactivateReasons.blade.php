            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <button type="button" class="btn btn-primary" data-role='addSubCategory' data-bs-toggle="tooltip" data-bs-dismiss="click" title="Add Reason" data-bs-custom-class="tooltip-dark">Add</button>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="kt_datatable">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @if(count($list)>0)
                                ...
                                <td>
                                    <?php echo stringReadMoreInline($item->content, 30); ?>
                                </td>
                                <td class="text-end">
                                    <div class="d-flex gap-3">
                                        <a href="#" data-id="{{ $item->id }}"
                                            data-title="{{ $item->title }}" data-content="{{ $item->content }}"
                                            data-role="editSubCategory" data-bs-toggle="tooltip"  title="Edit " data-bs-custom-class="tooltip-dark">
                                        ...
                                        <a href="#" id="deleteCatId" data-role="deleteEmailContaint"
                                            data-id="{{ $item->id }}" data-bs-toggle="tooltip"  title="Delete " data-bs-custom-class="tooltip-dark">
                            ...
                            @else
                            <tr>
                                <td><p class="w-100px">No Data Found</p></td>
                            </tr>
                            @endif
                        </tbody>
                        <!--end::Table body-->
        ...
        <div class="modal-content">
            ...
            <form class="form" id="kt_modal_add_city_form" enctype="multipart/form-data">
                ...
                <div class="modal-header" id="kt_modal_add_city_header">
                    ...
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div id="kt_modal_add_city_close" data-bs-dismiss="modal"
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_city_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7 mt-1">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control" placeholder="Reason content Title"
                                    name="content" id="title" value="" />
                                <!--end::Input-->
                            </div>
...
<script>
    ...
    // <!--Start::City Add Function-->
        $(document).on('click', 'button[data-role=addSubCategory]', function() {
            ...
            $('#model_heading').html('Add Reason Content');
    ...
    // <!--Start::City Edit Function-->
        $(document).on('click', 'a[data-role=editSubCategory]', function() {
            ...
            $("#subcat_id").val(id);
            $("#title").val(title);
            $('#model_heading').html('Edit Reason Content');
            $('#kt_modal_add_city').modal('toggle');
        });
    ...
    // <!--Start::Form Validation-->
        ...
        var validator = $('form[id="kt_modal_add_city_form"]').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "{{ route('admin.deactivereasons.create') }}",
                    method: "POST",
                    headers: {
                    ...
                    success: function(data) {
                        if(data == 1) {
                            $('#kt_modal_add_city').modal('toggle');
                            swal.fire({
                                text: "Reason Content has been successfully submitted!",
                                icon: "success",
                                buttonsStyling: !1,
    ...
    // <!--Start::City Delete Function-->
        $(document).on('click', 'a[data-role=deleteEmailContaint]', function() {
            ...
            var id = $(this).data('id');
            Swal.fire({
                text: "Are you sure you want to delete Reason Content?",
                icon: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                ...
                e.value ?
                $.ajax({
                    url: "{{ route('admin.deletedeactivereasons.delete') }}",
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    ...
                    success: function(data) {
                        if(data == 1) {
                            Swal.fire({
                                text: "You have deleted Reason Content!.",
                                icon: "success",
                                buttonsStyling: !1,
                                confirmButtonText: "Ok, Got it!",
                                customClass: {
