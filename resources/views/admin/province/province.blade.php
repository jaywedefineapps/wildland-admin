            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" id="myInput" data-kt-customer-table-filter="search"
                            class="form-control form-control-solid w-250px ps-15" placeholder="Search Province" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{route('provinces')}}" type="button" class="btn btn-dark me-4" >Reset</a>
                        <button type="button" class="btn btn-primary" data-role='addSubCategory' data-bs-toggle="tooltip" data-bs-dismiss="click" title="Add country" data-bs-custom-class="tooltip-dark">Add</button>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="kt_datatable">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr data-target="fullRow" id="{{ $item->id }}">
                                ...
                                <td>{{ $item->name }}</td>
                                <!--begin::Name=-->
                                <td>{{ $item->countryData->name }}</td>
                                <!--end::Name=-->
                                <!--begin::Payment method=-->
                                <td class="text-end">
                                    <div class="d-flex gap-3">
                                        <a href="#" data-id="{{ $item->id }}"
                                            data-name="{{ $item->name }}" data-country="{{ $item->country_id }}"
                                            data-role="editSubCategory" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Edit province" data-bs-custom-class="tooltip-dark">
...
<div class="modal fade" id="kt_modal_add_province" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" id="kt_modal_add_province_form" enctype="multipart/form-data">
                @csrf
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_add_province_header">
                    <!--begin::Modal title-->
                    <h2 id="model_heading" class="fw-bolder">Add a Province</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div id="kt_modal_add_province_close"
                ...
                <div class="modal-body py-10 px-lg-17">
                    <!--begin::Scroll-->
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_province_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7 mt-1">
                                ...
                                <input type="text" class="form-control" placeholder="Province Name"
                                    name="name" id="province_name" value="" />
                                <!--end::Input-->
                            </div>
                    ...
                    <div class="modal-footer flex-center">
                        <button type="reset" id="kt_modal_add_province_cancel"
                            class="btn btn-light me-3">Discard</button>
                        <button type="submit" id="kt_modal_add_province_submit"
...
<script>
    ...
    // <!--Start::Province Add Function-->
        $(document).on('click', 'button[data-role=addSubCategory]', function() {
            validator.resetForm();
            $('#kt_modal_add_province_form')[0].reset();
            $('#model_heading').html('Add Province');
            $('#kt_modal_add_province').modal('toggle');
        });
    // <!--End::Province Add Function-->

    // <!--Start::Province Edit Function-->
        $(document).on('click', 'a[data-role=editSubCategory]', function() {
            ...
            $('#model_heading').html('Edit a Province');
            $('#kt_modal_add_province').modal('toggle');
        });
    // <!--End::Province Edit Function-->
    ...
    // <!--Start::Form Validation-->
        ...
        var validator = $('form[id="kt_modal_add_province_form"]').validate({
            rules: {
                name: {
                    noSpace: true
                },
            ...
            messages: {
                ...
                avatar: 'Country is required',
            },
            submitHandler: function(form) {
                var formData = new FormData($('#kt_modal_add_province_form')[0]);
                $.ajax({
                    url: "{{ route('admin.province.create') }}",
                    method: "POST",
                    headers: {
    ...
    // <!--Start::Province Delete Function-->
        $(document).on('click', 'a[data-role=deleteSubCategory]', function() {
            var id = $(this).data('id');
            Swal.fire({
                text: "Are you sure you want to delete Province?",
                icon: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                ...
                e.value ?
                $.ajax({
                    url: "{{ route('admin.province.delete') }}",
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
    ...
    // <!--End::Province Delete Function-->

    // <!--Start::Province Model Close Function-->
        $('#kt_modal_add_province_close').click(function() {
            $('#kt_modal_add_province').modal('toggle');
        })
    // <!--End::Province Model Close Function-->
    });
</script>
@endsection
