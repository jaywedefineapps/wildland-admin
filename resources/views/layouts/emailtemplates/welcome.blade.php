...
<tbody><tr>
<td align="center" bgcolor="" class="" valign="top" width="100%">
...
<tbody style="margin-top: 15px;">
  <tr class="">
<td class="">
<img alt="robot picture" class="" height="155" src="http://forealdating.eu-west-2.elasticbeanstalk.com/public/assets/media/logos/how.svg" width="155">

</td>
</tr>
<tr class=""><td style="color: #000000; font-size: 36px;" class="headline">Hi Jeet Welcome to FoReal!</td></tr>
<tr>
<td>
<center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
<td class="" style="color:#000000; font-weight: 400;"><br><br>
 <!-- {{-- A property management application that helps you manage your real estate portfolio with ease and efficiency. <br><br> --}} -->
  You have successfully been registered to <em>NDshopnet</em><br>
 <br>
