...
@endif
@if (in_array('relationship', $roleAccessesArray))
<div class="menu-item">
    <a class="menu-link @if (Route::currentRouteName() == 'admin.relationship') active @endif" href="{{ route('admin.relationship') }}"
        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if (in_array(Route::currentRouteName(), ['admin.faq','admin.faq.technician'])) show @endif">
    <span class="menu-link">
        <span class="menu-icon">
            <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
            <span class="svg-icon svg-icon-2">
...
@endif
@if (in_array('help_and_support', $roleAccessesArray))
<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if (in_array(Route::currentRouteName(), ['admin.user.helpSupport','admin.technician.helpSupport'])) show @endif">
    <span class="menu-link">
        <span class="menu-icon">
            <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
            <span class="svg-icon svg-icon-2">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @if (Route::currentRouteName() == 'admin.user.helpSupport') active @endif"
                href="{{ route('admin.user.helpSupport') }}" data-bs-toggle="tooltip" data-bs-trigger="hover"
                data-bs-dismiss="click" data-bs-placement="right">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @if (Route::currentRouteName() == 'admin.technician.helpSupport') active @endif"
                href="{{ route('admin.technician.helpSupport') }}" data-bs-toggle="tooltip" data-bs-trigger="hover"
                data-bs-dismiss="click" data-bs-placement="right">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
